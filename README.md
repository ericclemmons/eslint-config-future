# Eric Clemmons' [ESLint Shareable Config][docs] ![https://img.shields.io/npm/v/eslint-config-ericclemmons.svg](https://img.shields.io/npm/v/eslint-config-ericclemmons.svg?style=flat-square)
